...
import {
  ...
  UsersIcon,
  ShoppingCartIcon,
} from "@heroicons/react/24/outline"; // Import specific icons from Heroicons
...
const Sidebar = () => {
  ...
  const handleLogout = async () => {
    try {
      ...
      await axios.post(
        "https://book-store-backend-0839.onrender.com/logout",
        {},
        {
          headers: {
    ...
    >
      <nav>
        <ul>
          ...
          >
            <h1
              className="text-3xl font-bold mb-2 text-6xl"
              style={{
                color: "#bd9f67",
