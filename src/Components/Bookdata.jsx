...
const BookDashboard = () => {
  ...
  const fetchBooks = () => {
    setTimeout(() => {
      axios
        .get("https://book-store-backend-0839.onrender.com/books", {
          headers: {
  ...
  const handleDelete = (bookId) => {
    if (window.confirm("Are you sure you want to delete this book?")) {
      axios
        .delete(
          `https://book-store-backend-0839.onrender.com/books/${bookId}`,
          {
            headers: {
              Authorization: `Bearer ${sessionStorage.getItem("token")}`,
            },
  ...
  const handleSaveEdit = (updatedBook) => {
    axios
      .put(
        `https://book-store-backend-0839.onrender.com/books/${updatedBook._id}`,
        updatedBook,
        {
          headers: {
            Authorization: `Bearer ${sessionStorage.getItem("token")}`,
