    ...
    const fetchData = async () => {
      try {
        ...
        const [customersResponse, booksResponse, buyingResponse] =
          await Promise.all([
            axios.get(
              "https://book-store-backend-0839.onrender.com/customers",
              {
                headers: {
            ...
            axios.get("https://book-store-backend-0839.onrender.com/books", {
              headers: {
                Authorization: `Bearer ${token}`,
              },
            }),
            axios.get(
              "https://book-store-backend-0839.onrender.com/buyingmodules",
              {
                headers: {
                  Authorization: `Bearer ${token}`,
                },
