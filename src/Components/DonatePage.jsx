...
function ContactUs() {
  ...
  const handleSend = (e) => {
    ...
    axios
      .post(
        "https://book-store-backend-0839.onrender.com/send-message",
        formData
      )
      .then((response) => {
  ...
  return (
    <div
      className="relative h-[70vh] mb-8 bg-fixed bg-center bg-no-repeat bg-cover mt-4"
      style={{
        backgroundImage:
    ...
    >
      <div className="flex flex-col items-center justify-center h-full bg-blue-400 bg-opacity-30 ">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-playfair font-bold text-lime-100 mb-4 drop-shadow-lg">
          Contact Us Today
        </h1>
